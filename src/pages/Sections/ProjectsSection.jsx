    ...
    return (
        <div className="flex flex-col w-auto gap-8">
            ...
            <div className="flex flex-col w-auto gap-16">
                <Project name="Pixterest" tags={["React", "Tailwind", "API"]} description="Pixterest is a front-end Pinterest clone designed specifically for pixel art. Built with React, it features DeviantArt's RSS API to fetch posts which can be saved locally. It is designed to be fully responsive for every screen size. My inspiration for this project came from wanting to make a challenging website with my own personal spin." />
